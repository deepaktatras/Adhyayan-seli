...
?>
	<h1 class="page-title">
		...
		<?php echo $teacherAssessment['client_name']; ?> <big>&#8594;</big> Manage Validators/Teachers
	</h1>
...
Save Validators</button>
				...
				<?php //if($teacherAssessment['assessmentAssigned']==0){ ?><a title="Upload teacher list" class="btn btn-primary small-btn pull-right execUrl vtip " id="up_teacher" href="?controller=assessment&amp;action=assessorListUpload&type=teacher&taid=<?php echo $teacherAssessment['group_assessment_id']; ?>&amp;ispop=1">Upload List</a><?php //} ?>
			</h2>
