...
<a id="addUserBtn" class="btn btn-primary pull-right execUrl vtip fixonmodal" title="Click to add a new user." href="?controller=user&amp;action=createUser&amp;ispop=1">Add New</a>
		...
		<div class="collapse navbar-collapse tabitemsHldr" id="tab4_Toggle">
			<ul class="yellowTab nav nav-tabs">          
				<li class="item active"><a href="Javascript:void(0);" data-toggle="tab" class="vtip" title="Create/ Edit Student Review">Step 1</a></li>
				<li class="item"><a href="Javascript:void(0);" data-toggle="tab" class="vtip" title="Manage Validators/Students" disabled="disabled">Step 2</a></li>				
			</ul>
					...
					<div class="subTabWorkspace pad26">
                                            <div>
							<form method="post" id="create_student_assessment_form" action="">
										...
										<dd>
											<div class="row">
												<div class="col-sm-6">
													...
													<a id="selectClientBtn" data-size="1050" data-postformid="for" title="Click to select a school/batch." class="btn btn-danger vtip execUrl" href="?controller=client&amp;action=clientList&amp;ispop=1">Select School/Batch</a>
									...
									<dl class="fldList">
										...
										<dd>
											...
											<div class="row">
												...
												<div class="col-sm-6">
													<select class="form-control student_round" autocomplete="off" name="student_round" >
