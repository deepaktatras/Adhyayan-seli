...
<div class="">
    <div class="ylwRibbonHldr">
        <span class="btn btn-primary pull-right execUrl mr30" id="sampleAssBtn">Download AQS Sample For Upload</span>
        <div class="tabitemsHldr"></div>
    </div>
    <div class="subTabWorkspace pad26">
        <div class="form-stmnt">
            <form method="post" id="upload_aqs_form" action="">
                <div class="boxBody">
                   ...
                   <dl class="fldList">
                       <dt>Upload AQS Sheet<span class="astric">*</span>:</dt>
                       <dd>
                   ...
                   <dl class="fldList">
                        ...
                        <dd class="nobg">
                            ...
                            <div class="ajaxMsg" id="createresource" style="display:none;"></div>
