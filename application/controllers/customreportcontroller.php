...
class customReportController extends controller {
	...
	function ngDataViewAction(){
        ...
        function generatedcustomdatasummaryAction(){
            $network_report_id=isset($_GET['network_report_id'])?$_GET['network_report_id']:'';
            if(empty($network_report_id)){
               $this->_notPermitted = 1; 
            }else{
              $this->set ( "network_report_id", $network_report_id ); 
              $customreportModel = new customreportModel ();	
              $network_report=$customreportModel->getNetworkReportsListfromID($network_report_id);
              $this->set ( "network_report", $network_report );
            }
